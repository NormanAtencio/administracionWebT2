...
3. Una vez se encontraban las fuentes, en el apartado de configuraciones se estableció cual rama se debe desplegar en el GitHub Pages.
4. Al seleccionar la rama se crea el action que se ejecutará cada vez que se actualice la rama main. El job del action compilará las fuentes y realizará la publicación en el sub dominio de Github Pages cada vez
   que se haga un push.
